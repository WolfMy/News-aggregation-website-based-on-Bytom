...
import pymongo
class Weibo:
    cookie = {"Cookie": "_T_WM=85605997349; ALF=1559553987; SCF=ApCcsRIsEhtaEZPgEkMBmnzp6L38hjfvU-eZLK2wtxrAjxDYlAiTUy3n6SpI2QXyXoogIAR8FBW4aFEMcynKS-k.; SUB=_2A25xySqUDeRhGeNI7FUX9SjPyjiIHXVTNbbcrDV6PUNbktANLXGikW1NSCVy52sGo1O0enCYre0qoPZInBEfAUMl; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WWxyxYD6ss-rO_BucZrC2XJ5JpX5KMhUgL.Fo-cS0McSKq0eKB2dJLoI7p-xFXEe-9aMJHc9Pzt; SUHB=0LcS621wnelfje; SSOLoginState=1556961988"}  # 将your cookie替换成自己的cookie
    ...
    def __init__(self, user_id, filter=0):
        ...
        self.Bytom_info_test = self.client['bytom_info']
        self.weibo2 = self.Bytom_info_test['weibo2']
        ...
        try:
            ...
            for i in range(1, self.weibo_num2 + 1):
                ...
                data = {
                    ...
                    "position":self.weibo_place[i - 1],
                    "likenum":str(self.up_num[i - 1]),
                    "retweet":str(self.retweet_num[i - 1]),
                    "commentnum":str(self.comment_num[i - 1]),
                    "publishtool":self.publish_tool[i - 1]

                }
                print(data)
                self.weibo2.insert_one(data)
                # result = result + text
...
def main():
    try:
        ...
        user_id = 5966947038  # 可以改成任意合法的用户id（爬虫的微博id除外）
